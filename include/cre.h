...
public:
  ...
  virtual ~CRE() = default;
  virtual double get_emissivity_t(const hvec<3, double> &, const Param *,
                                  const Grid_cre *, const double &) const;
  virtual double get_emissivity_p(const hvec<3, double> &, const Param *,
                                  const Grid_cre *, const double &) const;
  ...
  virtual double read_grid(const std::size_t &, const hvec<3, double> &,
  ...
  virtual double flux(const hvec<3, double> &, const Param *,
                      const double &) const;
};
...
public:
  ...
  double get_emissivity_t(const hvec<3, double> &, const Param *,
                          const Grid_cre *, const double &) const override;
  double get_emissivity_p(const hvec<3, double> &, const Param *,
                          const Grid_cre *, const double &) const override;
  double flux(const hvec<3, double> &, const Param *,
              const double &) const override;
  // flux normalization at given position
  double flux_norm(const hvec<3, double> &, const Param *) const;
  // flux index at given position
  double flux_idx(const hvec<3, double> &, const Param *) const;
  // spatial CRE flux rescaling
  double rescal(const hvec<3, double> &, const Param *) const;
};
