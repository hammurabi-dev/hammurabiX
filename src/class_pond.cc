...
void Pond::b_pond(XMLDocument *doc){
    ...
    brnd_anil.push_back(FetchDouble(subptr,"beta"));
    brnd_anil.push_back(FetchDouble(subptr,"Ma"));
    brnd_anil.push_back(FetchDouble(subptr,"rf"));
    brnd_anil.push_back(FetchDouble(subptr,"rs"));
