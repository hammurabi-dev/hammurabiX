...
void Pond::b_pond(XMLDocument *doc){
    ...
    bwmap.b0 = FetchDouble(subptr,"b0"); //microGauss
    bwmap.psi0 = FetchDouble(subptr,"psi0"); //deg
    bwmap.psi1 = FetchDouble(subptr,"psi1"); //deg
    bwmap.chi0 = FetchDouble(subptr,"chi0"); //deg
    // brnd_iso
...
void Pond::fe_pond(XMLDocument *doc){
    ...
    fe_ymw16.R_warp = FetchDouble(subptr,"R_warp")*CGS_U_kpc; //kpc
    fe_ymw16.R0 = FetchDouble(subptr,"R0")*CGS_U_kpc; //kpc
    fe_ymw16.t0_Gamma_w = FetchDouble(subptr,"Gamma_w");
    // thick disk
    subptr = ptr->FirstChildElement("YMW16")->FirstChildElement("ThickDisk");
    fe_ymw16.t1_Ad = FetchDouble(subptr,"Ad")*CGS_U_pc;//pc
    fe_ymw16.t1_Bd = FetchDouble(subptr,"Bd")*CGS_U_pc;//pc
    fe_ymw16.t1_n1 = FetchDouble(subptr,"n1");//pccm
    fe_ymw16.t1_H1 = FetchDouble(subptr,"H1")*CGS_U_pc;//pc
    // thin disk
    subptr = ptr->FirstChildElement("YMW16")->FirstChildElement("ThinDisk");
    fe_ymw16.t2_A2 = FetchDouble(subptr,"A2")*CGS_U_pc;//pc
    fe_ymw16.t2_B2 = FetchDouble(subptr,"B2")*CGS_U_pc;//pc
    fe_ymw16.t2_n2 = FetchDouble(subptr,"n2");//pccm
    fe_ymw16.t2_K2 = FetchDouble(subptr,"K2");
    // spiral arm
    subptr = ptr->FirstChildElement("YMW16")->FirstChildElement("SpiralArm");
    fe_ymw16.t3_B2s = FetchDouble(subptr,"B2s")*CGS_U_pc; //pc
    fe_ymw16.t3_narm[0] = FetchDouble(subptr,"Ele_arm_0");//pccm
    fe_ymw16.t3_narm[1] = FetchDouble(subptr,"Ele_arm_1");
    fe_ymw16.t3_narm[2] = FetchDouble(subptr,"Ele_arm_2");
    fe_ymw16.t3_narm[3] = FetchDouble(subptr,"Ele_arm_3");
    fe_ymw16.t3_narm[4] = FetchDouble(subptr,"Ele_arm_4");
    fe_ymw16.t3_warm[0] = FetchDouble(subptr,"Wid_arm_0")*CGS_U_pc;//pc
    fe_ymw16.t3_warm[1] = FetchDouble(subptr,"Wid_arm_1")*CGS_U_pc;
    fe_ymw16.t3_warm[2] = FetchDouble(subptr,"Wid_arm_2")*CGS_U_pc;
    fe_ymw16.t3_warm[3] = FetchDouble(subptr,"Wid_arm_3")*CGS_U_pc;
    fe_ymw16.t3_warm[4] = FetchDouble(subptr,"Wid_arm_4")*CGS_U_pc;
    fe_ymw16.t3_Aa = FetchDouble(subptr,"Aa")*CGS_U_pc;//pc
    fe_ymw16.t3_Ka = FetchDouble(subptr,"Ka");
    fe_ymw16.t3_ncn = FetchDouble(subptr,"ncn");
    fe_ymw16.t3_thetacn = FetchDouble(subptr,"thetacn");//deg
    fe_ymw16.t3_wcn = FetchDouble(subptr,"wcn");//deg
    fe_ymw16.t3_nsg = FetchDouble(subptr,"nsg");
    fe_ymw16.t3_thetasg = FetchDouble(subptr,"thetasg");//deg
    fe_ymw16.t3_wsg = FetchDouble(subptr,"wsg");//deg
    // gc
    subptr = ptr->FirstChildElement("YMW16")->FirstChildElement("GalCenter");
    fe_ymw16.t4_ngc = FetchDouble(subptr,"ngc");//pccm
    fe_ymw16.t4_Agc = FetchDouble(subptr,"Agc")*CGS_U_pc;//pc
    fe_ymw16.t4_Hgc = FetchDouble(subptr,"Hgc")*CGS_U_pc;//pc
    // Gum
    subptr = ptr->FirstChildElement("YMW16")->FirstChildElement("GumNebula");
    fe_ymw16.t5_ngn = FetchDouble(subptr,"ngn");//pccm
    fe_ymw16.t5_Wgn = FetchDouble(subptr,"Wgn")*CGS_U_pc;//pc
    fe_ymw16.t5_Agn = FetchDouble(subptr,"Agn")*CGS_U_pc;//pc
    fe_ymw16.t5_Kgn = FetchDouble(subptr,"Kgn");
    // Local Bubble
    subptr = ptr->FirstChildElement("YMW16")->FirstChildElement("LocalBubble");
    fe_ymw16.t6_J_LB = FetchDouble(subptr,"J_LB");
    fe_ymw16.t6_nlb1 = FetchDouble(subptr,"nlb1");//pccm
    fe_ymw16.t6_thetalb1 = FetchDouble(subptr,"thetalb1");//deg
    fe_ymw16.t6_detlb1 = FetchDouble(subptr,"detlb1");//deg
    fe_ymw16.t6_wlb1 = FetchDouble(subptr,"wlb1")*CGS_U_pc;//pc
    fe_ymw16.t6_hlb1 = FetchDouble(subptr,"hlb1")*CGS_U_pc;//pc
    fe_ymw16.t6_nlb2 = FetchDouble(subptr,"nlb2");//pccm
    fe_ymw16.t6_thetalb2 = FetchDouble(subptr,"thetalb2");//deg
    fe_ymw16.t6_detlb2 = FetchDouble(subptr,"detlb2");//deg
    fe_ymw16.t6_wlb2 = FetchDouble(subptr,"wlb2")*CGS_U_pc;//pc
    fe_ymw16.t6_hlb2 = FetchDouble(subptr,"hlb2")*CGS_U_pc;//pc
    // Loop I
    subptr = ptr->FirstChildElement("YMW16")->FirstChildElement("LoopI");
    fe_ymw16.t7_nLI = FetchDouble(subptr,"nLI");//pccm
    fe_ymw16.t7_RLI = FetchDouble(subptr,"RLI")*CGS_U_pc;//pc
    fe_ymw16.t7_WLI = FetchDouble(subptr,"WLI")*CGS_U_pc;//pc
    fe_ymw16.t7_detthetaLI = FetchDouble(subptr,"detthetaLI");//deg
    fe_ymw16.t7_thetaLI = FetchDouble(subptr,"thetaLI");//deg
    ...
    subptr = ptr->FirstChildElement("Random")->FirstChildElement("Rescal");
    fernd_scal.r0 = FetchDouble(subptr,"r0");
    fernd_scal.z0 = FetchDouble(subptr,"z0");
