...
ham_float CRE_unif::spatial_profile(const Hamvec<3, ham_float> &pos,
...
ham_float CRE_unif::flux_idx(const Hamvec<3, ham_float> & /*pos*/,
                             const Param *par) const {
...
ham_float CRE_unif::flux_norm(const Hamvec<3, ham_float> &pos,
                              const Param *par) const {
  ...
  const ham_float gamma0{par->cre_unif.E0 / cgs::mec2};
  ...
  const ham_float norm{par->cre_unif.j0 *
...
ham_float CRE_unif::write_field(const Hamvec<3, ham_float> &pos,
